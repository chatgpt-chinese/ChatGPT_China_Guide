# ChatGPT 中文版：国内使用入口（支持 GPT-4.1、GPT-4o、4o画图、o1 和 o3，无需翻墙）【9月最新更新】

> **更新日期：2025/09/22**   

**国内直接用的 [ChatGPT 中文版](https://gpt.lanjingai.org)**，**无需翻墙**即可使用 GPT-4、o1、o3及多功能应用！     
...
**ChatGPT 镜像网站**直达：**[https://gpt.lanjingai.org](https://gpt.lanjingai.org)**
...
[**ChatGPT 中文版**](https://gpt.lanjingai.org)是基于 OpenAI的 ChatGPT模型的中文使用版本，专为中文用户，提供更流畅、更精准的 智能AI对话。很多方面更适合国内用户：
...
| **[gpt.lanjingai.org](https://gpt.lanjingai.org)**  | GPT-4, GPT-3.5, o1, o3, DeepSeek-R1, Claude 4 sonnet  | ⭐⭐⭐⭐⭐  | 使用简单，先进大模型，适合新手用户       |
